...
class MakeInterfaceCommand extends GeneratorCommand
{
     ...
     * @var string
     */
    protected $signature = 'module:interface {name} {--section=}';
    ...
    {
        return app_path('Console/Stubs/Module/interface.stub');
    }
    ...
    protected function getNameInput()
    {
        ...
        return $path . $section . $class .'/'. $class . 'RepositoryInterface';
    }
}
